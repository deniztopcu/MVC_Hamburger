...
namespace MVC_Hamburger.Areas.YonetimPaneli.Controllers
{
    ...
    public class EkstraMalzemeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KategoriAdi,ID,Ad,Fiyat,MenuAdet")] EkstraMalzeme ekstraMalzeme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KategoriAdi,ID,Ad,Fiyat,MenuAdet")] EkstraMalzeme ekstraMalzeme)
        {
